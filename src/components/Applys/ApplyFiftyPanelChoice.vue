<template>
        ...
        <div class="row">
                ...
                <div class="box box-primary" >
                    <div class="box-header with-border">
                        <div class="row">
                            ...
                            <div class="col-md-4  col-sm-4">
                                <h5>格式:一张两列</h5>
                                <button class="" @click="PrintBillTwo(0)">打印选择商品</button>
                            </div>
                        </div>
                    ...
                    <div class="box-body no-padding row">
                        <div class="col-md-10 col-sm-1" id="deliveryOrderNew" style="background: #fff; ">
                                ...
                                <tr v-for="(item, index) in applyArrPrint">
                                    <td class="text-center">
                                        ...
                                        <label class="css-input css-checkbox css-checkbox-primary">
                                            ...
                                            <input  :checked="item.hasChoice" type="checkbox" @click="choice(index)" ><span></span>
                ...
                <div class="box box-primary" >
                    <div class="box-header with-border">
                        <div class="row">
                            ...
                            <div class="col-md-4  col-sm-4">
                                <h5>格式:一张两列</h5>
                                <button  class="btn btn-success btn-sm" style="padding: 4px 54px; margin: 10px 0px ;" @click="PrintBillTwo(index)">部门打印</button>
                            </div>
                        </div>
            ...
            <div style="display: none" id="testDeliveryTwoChoice"></div>
    ...
    export default {
        ...
        mounted() {
            ...
            $('#deliveryOrderNew').on('keyup', 'input', function (e) {
                ...
                var nxDoSubtotal = (Number(orderPrice) * Number(orderQuantity)).toFixed(1)
                    ...
                    data.nxDoWeight = newQuantity;
                    data.nxDoPrice = newPrice;
        ...
        methods: {
            ...
            getOrderPageForPrint(){
                var data = "depFatherId=" + parseInt(this.nxDepFatherId) + "&gbDepFatherId="
                    + parseInt(this.gbDepId) + "&resFatherId=" + parseInt(this.resFatherId)+ "&disId=" + this.disId;
                api.disGetToFillDepOrders(data).then(res => {
                    console.log(res);
                    console.log("getdpriririririiririiriirir");
            ...
            printOk(){
                ...
                console.log("prinsososkskskskkskk")
            ...
            PrintBillTwoMain: function () {
                ...
                if (totalPriPage <= 1) {
                    ...
                    $('#testDeliveryTwoChoice').append(applyBody);
